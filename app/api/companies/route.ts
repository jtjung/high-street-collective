...
const COLUMNS =
  "id, name, subtypes, category, phone, email, address, street, city, postal_code, area, neighborhood, country_code, verified, rating, reviews, location_link, website, instagram, facebook, linkedin, x_twitter, youtube, working_hours, business_status, outcomes, callback_at, not_interested_reason, pain_points, user_goals, contact_name, contact_address, contact_method, contact_notes, outscraper_place_id, latitude, longitude";
